/**
 * Resend OTP Email Template (Dark Theme UI Matching)
 * @param {string} doctorName - Doctor ka name
 * @param {string} otp - 6-digit OTP code
 * @returns {string} HTML Template string
 */
export const resendOtpEmailTemp = (doctorName, otp) => {
  return `
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
      <div class="container">
        ...
        <div class="body">
          <div class="title">Resend OTP Request</div>
          <p class="text">Hello <strong style="color: #e2e8f0;">Dr. ${doctorName}</strong>,</p>
          <p class="text">You requested a new verification code. Please use the verification code below to complete your action:</p>
