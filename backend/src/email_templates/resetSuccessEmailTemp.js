/**
 * Reset Success Email Template (Dark Theme UI Matching)
 * @param {string} doctorName - Doctor ka name
 * @returns {string} HTML Template string
 */
export const resetSuccessEmailTemp = (doctorName) => {
  return `
    <!DOCTYPE html>
    <html>
    <head>
      ...
      <style>
        ...
        .warning { color: #ef4444; font-size: 13px; line-height: 1.4; margin-top: 24px; }
    ...
    <body>
      <div class="container">
        ...
        <div class="body">
          ...
          <p class="text">Your password for the Vaccination Management System has been reset successfully.</p>
